...
<?php 
	...
	else
	{
		...
		{			
			...
			//Update complaint status of subscriber
			$q = 'UPDATE subscribers SET unsubscribed = 0, bounced = 0, complaint = 1, timestamp = '.$time.' WHERE messageID = "'.mysqli_real_escape_string($mysqli, $messageId).'"';
